...
#               destfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_BATS_2019_comp.xlsx", mode = "wb")

# download data
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2007-sup-0002-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import data
ba_occ <- readxl::read_xlsx("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_BATS_2019_comp.xlsx") %>% 
...
# # unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy1998-sup-0001-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")
 
# import sites
ca_si <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_CAMTRAPS_1-0_LOCATION.csv") %>%
    dplyr::select(location_id, X, Y)
ca_si

# import sites names
ca_si_na <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_CAMTRAPS_1-0_SURVEY.csv") %>% 
    dplyr::left_join(., ca_si, by = "location_id") %>% 
    dplyr::select(location_id, survey_id, yearfinish,  X, Y)
ca_si_na

# import species names
ca_sp_na <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_CAMTRAPS_1-0_SPECIES.csv") %>% 
    dplyr::select(order:genus, species_name, species_code)
ca_sp_na

# import species
ca_sp <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_CAMTRAPS_1-0_RECORDS.csv") %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2785-sup-0001-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import data
lm_occ <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_MAMMAL_MID_LARGE _assemblages_and_sites.csv") %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2525-sup-0001-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import communities
pr_co <- read.csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC-PR_Community.csv", sep = ";") %>%
    tibble::as_tibble() %>% 
...
# import quantitative
pr_qu <- read.csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC-PR_Quantitative.csv", sep = ";") %>%
    tibble::as_tibble() %>%
    dplyr::mutate(source = "atlantic_primates") %>% 
    dplyr::filter(PRECISION == "Precise") %>% 
    dplyr::select(SPECIES, LONGITUDE_X, LATITUDE_Y, COL_END_YR, source)
...
# import occurrences
pr_oc <- read.csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC-PR_Occurrence.csv", sep = ";") %>%
    tibble::as_tibble() %>% 
    dplyr::mutate(source = "atlantic_primates") %>% 
    dplyr::filter(PRECISION == "Precise") %>% 
    dplyr::select(SPECIES, LONGITUDE_X, LATITUDE_Y, COL_END_YR, source)
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy1893-sup-0002-datas1.zip",
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import sites
sm_occ_si <- data.table::fread("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_SM_Study_Site.csv") %>% 
...
# import species
sm_occ_sp <- data.table::fread("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_SM_Capture.csv") %>%
    dplyr::rename(ID = `ID\xa0`) %>% 
    tibble::as_tibble() %>%
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2005-sup-0001-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import sites
sm_ab_si <- data.table::fread("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/Localities.csv") %>% 
    tibble::as_tibble() %>% 
...
# import species
sm_ab_sp <- data.table::fread("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/Mammal_Communities.csv") %>% 
    tibble::as_tibble() %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2107-sup-0002-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import sites
muprb_si <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/Mammals_UPRB_study_sites.csv")
muprb_si

muprb_sp <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/Mammals_UPRB_species.csv") %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2106-sup-0002-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import
mt_occ <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_TR_all_data.csv") %>% 
    janitor::clean_names() %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2119-sup-0002-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import
bird_qual <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_BIRDS_qualitative.csv") %>%
    janitor::clean_names() %>% 
...
bird_quan <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_BIRDS_quantitative.csv") %>%
    janitor::clean_names() %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2647-sup-0001-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import
bt_occ <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_BIRD_TRAITS_completed_2018_11_d05.csv") %>% 
    janitor::clean_names() %>% 
    dplyr::mutate(species = binomial,
...
# unzip
# unzip(zipfile = "01_data/00_occurrences/raw/04_data_papers/ecy3595-sup-0001-datas1.zip", 
#       exdir = "01_data/00_occurrences/raw/04_data_papers")

# import
po_fauna_occ <- readr::read_delim("01_data/01_occurrences/01_raw/01_fauna/04_data_papers//ATLANTIC-floverint_int.csv", delim = ";") %>% 
    janitor::clean_names() %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy1818-sup-0002-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import
fru_fauna_occ <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ATLANTIC_frugivory.csv") %>% 
    janitor::clean_names() %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/5929839.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import
bi_occ <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/SIA_BRA_1.0.csv") %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2464-sup-0001-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

br_occ <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/Brazil_Roadkill_20180527.csv") %>% 
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy3128-sup-0001-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import
neo_car_occ <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/NEOTROPICAL_CARNIVORES_DATASET_2020-04.csv") %>% 
...
# unrar
# system("unrar e 01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy2663-sup-0001-datas1.rar 01_data/01_occurrences/01_raw/01_fauna/04_data_papers/")

# import
neo_xen_qual <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/NEOTROPICAL_XENARTHRANS_QUALITATIVE.csv") %>%
...
neo_xen_quan <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/NEOTROPICAL_XENARTHRANS_QUANTITATIVE.csv") %>%
    dplyr::filter(PRECISION %in% c(as.character(0:100))) %>%
    dplyr::select(ORDER, FAMILY, GENUS, SPECIES, LONG_X, LAT_Y, COL_END_YR) %>% 
    dplyr::mutate(source = "neotropical_xenarthrans")
neo_xen_quan
...
# unzip
# unzip(zipfile = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers/ecy3115-sup-0001-datas1.zip", 
#       exdir = "01_data/01_occurrences/01_raw/01_fauna/04_data_papers")

# import
neo_alien_occ <- readr::read_delim("01_data/01_occurrences/01_raw/01_fauna/04_data_papers/DataS1/NEOTROPICAL_ALIEN_MAMMALS_OCCURENCE.csv", delim = ";") %>% 
    dplyr::filter(PRECISION %in% c(as.character(0:100))) %>%
    dplyr::mutate(species = SPECIES,
                  longitude = LONG_X, 
                  latitude = LAT_Y,
...
## combine ----
occ_data_papers_fauna <- dplyr::bind_rows(ba_occ, ca_occ, lm_occ, po_fauna_occ,
                                          pr_occ, sm_occ, sm_ab_occ, muprb_occ, 
                                          mt_occ, bird_occ, bt_occ,
                                          fru_fauna_occ, bi_occ, 
...
## export ----
readr::write_csv(occ_data_papers_fauna, "01_data/01_occurrences/01_raw/01_fauna/04_occ_raw_data_paper_fauna.csv")
