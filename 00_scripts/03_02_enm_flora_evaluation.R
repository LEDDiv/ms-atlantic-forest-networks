...
# export
readr::write_csv(data_ev, "02_results/03_evaluation/data_ev_plants.csv")
readr::write_csv(data_ev_sum, "02_results/03_evaluation/data_ev_sum_plants.csv")
