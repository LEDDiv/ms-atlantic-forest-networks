...
# list
occ <- dir(path = "01_data/01_occurrences/01_raw/01_fauna/01_gbif_idigbio_vertnet_specieslink", pattern = ".csv") %>% 
    stringr::str_replace_all("occ_raw_splink_spocc_fauna_", "") %>% 
...
foreach::foreach(i=fauna_list[!fauna_list %in% occ]) %do% {
    ...
    readr::write_csv(occ_data, 
                     paste0("01_data/01_occurrences/01_raw/01_fauna/01_gbif_idigbio_vertnet_specieslink/occ_raw_splink_spocc_fauna_", sub(" ", "_", tolower(i)), ".csv"))
...
occ_data_fauna <- dir(path = "01_data/01_occurrences/01_raw/01_fauna/01_gbif_idigbio_vertnet_specieslink/", 
...
# export
readr::write_csv(occ_data_fauna, "01_data/01_occurrences/01_raw/01_fauna/occ_raw_splink_spocc_fauna.csv")
