...
# import
list_files_portalbio <- dir(path = "01_data/01_occurrences/01_raw/01_fauna/05_plataforma_biodiversidade", pattern = ".csv", recursive = TRUE, full.names = TRUE) %>% 
    stringr::str_subset(pattern = "portalbio_export")
list_files_portalbio

occ_portalbio <- readr::read_csv("01_data/01_occurrences/01_raw/01_fauna/05_plataforma_biodiversidade/portalbio_one_species.csv")
...
# export
readr::write_csv(occ_portalbio_fauna, "01_data/01_occurrences/01_raw/01_fauna/05_occ_raw_portalbio_fauna.csv")
